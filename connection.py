...
# 定義查核藥師列表
PHARMACISTS =['', '廖文佑', '洪英哲', '楊曜嘉', '劉芷妘', '林昱男', '郭莉萱', '蔡尚憲', '鍾向渝', '吳雨柔', '侯佳旻', '蘇宜萱', '王孝軒', '王奕祺', 
                  '周芷伊', '簡妙格', '陳威如', '邱柏翰', '紀晨雲', '吳振凌', '羅志軒', '王威智', '劉川葆', '江廷昌', '凃惠敏', '張淑娟', '李典則', 
                  '熊麗婷', '許家誠', '盧柏融', '劉奕君', '張雯婷', '張亦汝', '陳意涵', '林坤瑝', '蔡文子', '王奕祺', '邱柏翰', '呂奕芸'] 
